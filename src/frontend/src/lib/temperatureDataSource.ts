...
const DATA_URL =
  "https://script.google.com/macros/s/AKfycbxnSb-bzTLWQmbHbo-ZBwxZn9444juSqzHjLokPZklrA86hXME_rt3NH8x1d-8xo8ZJoQ/exec";
...
export async function fetchTemperatureData(): Promise<TemperatureDataPoint[]> {
  try {
    ...
    throw error instanceof Error
      ? error
      : new Error("Failed to fetch temperature data");
  }
}
